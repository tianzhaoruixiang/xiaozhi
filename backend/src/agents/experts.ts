...
- 口述汇报：办会/通知类只用一句「会议已通知到相关人员，其中由两位外出领导授权数智助手参会。」不要报时间地点材料齐套，不要「请您指示」
- 其他任务口述最多 2 句，直接说结果
- 口述中的时间必须是汉字读法，严禁 14:00、9:30 这种阿拉伯数字冒号时间（会播报错误），只说「十四点整」「九点三十分」
...
- 办会/通知类只用一句：会议已通知到相关人员，其中由两位外出领导授权数智助手参会
- 不要报时间、地点、议程、材料齐套，不要「请您指示」
- 其他任务最多 2 句；根据本轮实际结果现写
- 时间日期数量用汉字读法；严禁 14:00、9:30
