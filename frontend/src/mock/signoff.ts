...
export const signoffDepartments: SignoffDepartment[] = [
  { id: 'command', name: '市局指挥中心', signer: '高卫明', role: '指挥长', order: 1, status: 'signed', signedAt: '11:48', sealCode: 'QZ-2401' },
  ...
  { id: 'traffic', name: '交警支队', signer: '何建', role: '交通保障负责人', order: 5, status: 'pending' },
...
export const signoffAssistantTasks: SignoffAssistantTask[] = [
  ...
  { title: '正在归档签章留痕', detail: '记录各责任单位签章时间与电子签章编号' },
