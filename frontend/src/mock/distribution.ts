...
export const distributionGroups: DistributionGroup[] = [
  {
    id: 'x', name: '人员审核组', responsibility: '境外参会人员审核', lead: '陈立文', department: '出入境管理支队', memberCount: 8, color: '#54d6ff',
  },
  {
    id: 'y', name: '舆情监测组', responsibility: '会议及场馆舆情监测', lead: '赵敏婕', department: '网安支队', memberCount: 12, color: '#6e8cff',
  },
  {
    id: 'z', name: '现场安保组', responsibility: '核心区域现场安保', lead: '王凯铭', department: '治安支队', memberCount: 46, color: '#45e0b4',
  },
  {
    id: 'e', name: '场馆检查组', responsibility: '会前重点场馆检查', lead: '孙梅芳', department: '内保支队', memberCount: 10, color: '#efc24f',
  },
  {
    id: 'f', name: '重点监测组', responsibility: '重点群体动态监测', lead: '周晓宁', department: '情报支队', memberCount: 9, color: '#e78962',
  },
  {
    id: 'g', name: '情况通报组', responsibility: '情况汇总与通报', lead: '林珊琪', department: '市局指挥中心', memberCount: 6, color: '#a985ff',
  },
]
...
export const distributionTasks: DistributionTask[] = [
  {
    ...
    owner: '陈立文', collaborators: ['外事办联络员', '会务组'], deadline: '09月22日 18:00',
  ...
  },
  {
    ...
    owner: '赵敏婕', collaborators: ['宣传部门', '属地网安'], deadline: '09月22日 12:00',
  ...
  },
  {
    ...
    owner: '王凯铭', collaborators: ['交警支队', '属地分局'], deadline: '09月23日 16:00',
  ...
  },
  {
    ...
    owner: '刘超群', collaborators: ['特警支队', '交警支队'], deadline: '09月23日 18:00',
  ...
  },
  {
    ...
    owner: '孙梅芳', collaborators: ['消防救援支队', '场馆方'], deadline: '09月23日 12:00',
  ...
  },
  {
    ...
    owner: '周晓宁', collaborators: ['属地分局', '情报专班'], deadline: '09月22日 20:00',
  ...
  },
  {
    ...
    owner: '林珊琪', collaborators: ['各作战组联络员'], deadline: '09月22日 18:00',
  ...
  },
  {
    ...
    owner: '林珊琪', collaborators: ['法制支队', '人员审核组'], deadline: '09月23日 10:00',
