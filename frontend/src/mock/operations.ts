...
export const operationMessages: ChatMessage[] = [
  ...
  { id: 'x-2', groupId: 'x', sender: '陈立文', role: '组长', avatar: '陈', time: '13:08', kind: 'text', content: '名单共126人。请先核验身份、证件有效期和申报行程，发现资料不完整的直接在任务卡反馈。' },
  { id: 'x-3', groupId: 'x', sender: '作战助手', role: '智能协同成员', avatar: '智', time: '13:09', kind: 'task', isAssistant: true, title: '首轮审核任务已拆分', content: '已按名单批次分发给4名审核人员，并设置18:00前完成、异常双人复核的规则。', meta: '126人 · 4个批次 · 负责人陈立文', progress: 68, tags: ['身份核验', '证件核验', '行程比对'], actions: ['查看任务', '调整分工'], source: '任务 task-x-01 · 最终方案条文 2.1' },
  ...
  { id: 'y-2', groupId: 'y', sender: '赵敏婕', role: '组长', avatar: '赵', time: '13:20', kind: 'text', content: '重点关注活动名称、举办场馆和周边交通三个方向，异常传播链路立即上报。' },
  ...
  { id: 'z-2', groupId: 'z', sender: '王凯铭', role: '组长', avatar: '王', time: '13:24', kind: 'text', content: '各区域负责人按岗点图确认人员、设备和到场路线，东侧区域注意09:30边界切换条件。' },
  { id: 'z-3', groupId: 'z', sender: '刘超群', role: '机动单元负责人', avatar: '刘', time: '14:08', kind: 'feedback', title: '第三联合机动单元反馈', content: '12名队员、2台车辆已完成编成，到场路线与交警支队完成确认。', meta: '力量到位率 100% · 联动确认完成', tags: ['编成完成', '路线已确认'], actions: ['查看编成表', '确认反馈'] },
  ...
  { id: 'e-2', groupId: 'e', sender: '孙梅芳', role: '组长', avatar: '孙', time: '13:35', kind: 'text', content: '检查清单分为三组同步执行，发现隐患必须附现场照片、责任人和整改时限。' },
  ...
  { id: 'f-2', groupId: 'f', sender: '周晓宁', role: '组长', avatar: '周', time: '13:42', kind: 'text', content: '第一轮分级清单已建立，属地联络员按既定要求反馈动态，重大变化直接报指挥中心。' },
  ...
  { id: 'g-2', groupId: 'g', sender: '林珊琪', role: '组长', avatar: '林', time: '13:18', kind: 'text', content: '请各组17:00前提交当日进展、异常和次日安排，重大事项随时报送。' },
...
export const supplementalOperationTasks: OperationTask[] = [
  ...
  { id: 'op-x-report', groupId: 'x', title: '形成境外人员审核结论', description: '汇总审核结果、异常事项和处置记录。', owner: '陈立文', collaborators: ['李娜', '张磊'], deadline: '今日 18:30', deliverable: '审核结论报告', priority: 'important', status: 'pending', progress: 0, feedbackCount: 0, updatedAt: '13:09', sourceClauseIds: ['rev-201'] },
  ...
  { id: 'op-z-switch', groupId: 'z', title: '确认东侧边界切换条件', description: '核对09:30后的缓冲区恢复条件、口令和责任人。', owner: '王凯铭', collaborators: ['交警支队'], deadline: '09月23日 16:00', deliverable: '现场确认记录', priority: 'important', status: 'review', progress: 90, feedbackCount: 2, updatedAt: '14:09', sourceClauseIds: ['rev-401'] },
  ...
  { id: 'op-e-room', groupId: 'e', title: '弱电机房登记复核', description: '补齐登记记录并由场馆负责人确认。', owner: '孙梅芳', collaborators: ['场馆方'], deadline: '今日 16:00', deliverable: '复核记录', priority: 'important', status: 'doing', progress: 60, feedbackCount: 1, updatedAt: '14:22', sourceClauseIds: ['rev-501'] },
  { id: 'op-f-round', groupId: 'f', title: '属地动态例行反馈', description: '按分级清单收集本轮动态并核对触发条件。', owner: '周晓宁', collaborators: ['属地分局'], deadline: '今日 15:00', deliverable: '动态反馈记录', priority: 'normal', status: 'review', progress: 88, feedbackCount: 7, updatedAt: '14:20', sourceClauseIds: [] },
  { id: 'op-g-daily', groupId: 'g', title: '汇总六组作战日报', description: '归集进展、异常和次日安排，形成情况通报草稿。', owner: '林珊琪', collaborators: ['各作战组联络员'], deadline: '今日 17:30', deliverable: '当日情况通报', priority: 'important', status: 'doing', progress: 60, feedbackCount: 7, updatedAt: '14:25', sourceClauseIds: ['rev-101'] },
]
